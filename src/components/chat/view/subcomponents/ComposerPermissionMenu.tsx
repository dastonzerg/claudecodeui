  ...
  return (
    <>
      <button
        ...
        className={`flex h-8 shrink-0 items-center justify-center gap-1.5 rounded-lg border px-2 transition-colors sm:w-8 sm:px-0 ${activeAppearance.trigger}`}
        aria-haspopup="menu"
      ...
      >
        ...
        {/* On narrow screens the icon alone does not say which mode is active,
            and opening the menu to find out is the expensive way to check. */}
