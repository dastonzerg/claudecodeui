  ...
  return (
    <div className="group relative my-2">
      ...
      <button
        ...
        // Icon-only and tucked into the corner: the label made this wide enough
        // to sit over the first line of code, which is content the user is
        // usually trying to read. The wording lives in title/aria-label instead.
        className="absolute right-1 top-1 z-10 rounded-md border border-border bg-card/90 p-1 text-foreground/80 opacity-0 transition-opacity hover:bg-muted focus:opacity-100 active:opacity-100 group-hover:opacity-100"
