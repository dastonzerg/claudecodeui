    ...
    <div className="flex h-full w-12 flex-col items-center gap-1 bg-background/80 py-3 backdrop-blur-sm">
      ...
      {restartRequired && (
        ...
        >
          ...
          <span className="absolute right-1.5 top-1.5 h-1.5 w-1.5 animate-pulse-brief rounded-full bg-amber-500" />
        </div>
      )}
      ...
      {updateAvailable && (
        ...
        >
          ...
          <span className="absolute right-1.5 top-1.5 h-1.5 w-1.5 animate-pulse-brief rounded-full bg-blue-500" />
        </button>
      )}
    </div>
  );
